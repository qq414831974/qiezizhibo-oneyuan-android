...
package com.qiezitv.view.verticalseekbar;
...
public class VerticalSeekBar extends AppCompatSeekBar {
    ...
    private boolean mDargable = true;
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs != null) {
            ...
            final Boolean interceptClick = a.getBoolean(R.styleable.VerticalSeekBar_interceptClick, false);
            if (interceptClick != null) {
                mInterceptClick = interceptClick;
            }
            final Boolean dargable = a.getBoolean(R.styleable.VerticalSeekBar_dragable, true);
            if (dargable != null) {
                mDargable = dargable;
            }
            a.recycle();
