...
public class RenderSrfTex {
    ...
    public void setWatermark(Watermark watermark) {
        ...
        if (watermark.isFullScreen()) {
            initWatermarkVertexBuffer(mVideoWidth, mVideoHeight, watermark.getOrientation(), watermark.getvMargin(), watermark.gethMargin());
        } else {
            initWatermarkVertexBuffer(watermark.getWidth(), watermark.getHeight(), watermark.getOrientation(), watermark.getvMargin(), watermark.gethMargin());
        }
    }
