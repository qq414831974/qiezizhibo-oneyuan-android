...
public abstract class Effect {
    ...
    private int sHandle = -1;
    private int hHandle = -1;
    ...
    private void loadShaderAndParams(String vertex, String fragment) {
        ...
        sHandle = GLES20.glGetUniformLocation(mProgram, "S");
        hHandle = GLES20.glGetUniformLocation(mProgram, "H");
        lHandle = GLES20.glGetUniformLocation(mProgram, "L");
        loadOtherParams();
