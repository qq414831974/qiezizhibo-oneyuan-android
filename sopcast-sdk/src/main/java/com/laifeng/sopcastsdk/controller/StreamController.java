...
public class StreamController implements OnAudioEncodeListener, OnVideoEncodeListener, Packer.OnPacketListener {
    ...
    public synchronized void start(final CameraLivingView.LivingStartListener livingStartListener) {
        SopCastUtils.processNotUI(new SopCastUtils.INotUIProcessor() {
            ...
            public void process() {
                ...
                mVideoController.start(livingStartListener);
            }
        });
    }
    ...
    public synchronized void restart(final CameraLivingView.LivingStartListener livingStartListener) {
        SopCastUtils.processNotUI(new SopCastUtils.INotUIProcessor() {
            @Override
            public void process() {
                mVideoController.setVideoEncoderListener(null);
